...
export class ListTicketsComponent {
  ...
  constructor() {
    this.tickets = [
      { id: 1, title: "Bad Packaging", category: "Shipping", description: "Something went wrong", date: new Date(), status: "Pending", userId: "2" },
      ...
      { id: 3, title: "Bad Driver", category: "Other", description: "I want to reshcedule", date: new Date(), status: "Solved", userId: "1" }
    ];
  }
